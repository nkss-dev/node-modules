  ...
  return (
    <div>
      <header>
        ...
        <h2>v1-alpha</h2>
        <p>
          Welcome! The <Link href="/about">NKSSS team</Link> aims to solve as many
          issues you face in our college as technologically possible! The
          ...
          <br />
          <br />
          <strong>PS:</strong> NKSSS is <em>NOT</em> affiliated with NITKKR and is completely
          student run.
        </p>
      </header>
    </div>
